...
export default function Hero() {
  ...
  return (
    <div
      className="relative min-h-screen bg-[#0a0225] overflow-hidden"
      id="home"
    >
      ...
      <nav
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          isScrolled
            ? 'bg-[#0a0225]/95 backdrop-blur-lg shadow-lg shadow-black/10'
            : 'bg-transparent'
        }`}
      >
          ...
          <div className="flex items-center justify-between h-24">
            ...
            <div className="relative z-10">
              <span className="text-3xl font-bold relative">
                ...
                <span className="relative bg-gradient-to-r from-red-500 to-blue-500 bg-clip-text text-transparent">
                  BK
                </span>
              </span>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-16 transform transition-all duration-700 translate-y-0 opacity-100">
            <div className="space-y-6">
              <h2 className="text-xl text-gray-400 animate-fade-in">
                Hello, I am
              </h2>
            ...
            <p className="text-gray-400 text-lg max-w-xl leading-relaxed animate-fade-in">
              A passionate{' '}
              <span className="text-red-500">Computer Science Engineer</span>{' '}
              with expertise in creating innovative solutions. Specializing in
              full-stack development, UI/UX design, and AI integration.
            </p>
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-6">
                <a
                  href="https://github.com/Bhumisvara2k"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="GitHub Profile"
                  className="w-14 h-14 bg-white/5 rounded-full flex items-center justify-center hover:bg-[#2b3137] transition-all duration-300 group hover:scale-110"
                >
                  <Github className="w-7 h-7 text-[#2b3137] group-hover:text-white" />
                </a>
                <a
                  href="https://www.linkedin.com/in/bhumisk"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="LinkedIn Profile"
                  className="w-14 h-14 bg-white/5 rounded-full flex items-center justify-center hover:bg-[#0077b5] transition-all duration-300 group hover:scale-110"
                >
                  <Linkedin className="w-7 h-7 text-[#0077b5] group-hover:text-white" />
                </a>
                <a
                  href="https://www.instagram.com/bhumisvarak"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Instagram Profile"
                  className="w-14 h-14 bg-white/5 rounded-full flex items-center justify-center hover:bg-[#e4405f] transition-all duration-300 group hover:scale-110"
                >
                  <Instagram className="w-7 h-7 text-[#e4405f] group-hover:text-white" />
                </a>
                <a
                  href="https://wa.me/+919345050311"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="WhatsApp Contact"
                  className="w-14 h-14 bg-white/5 rounded-full flex items-center justify-center hover:bg-[#25D366] transition-all duration-300 group hover:scale-110"
                >
          ...
          <div className="relative transform transition-all duration-700 translate-x-0 opacity-100">
            ...
            <div
              key={refreshKey}
              className={`relative z-10 w-[400px] h-[500px] mx-auto transform transition-all duration-1000 ${
                imageLoaded
            ...
            >
              ...
              <div className="relative h-full overflow-hidden rounded-2xl shadow-[0_0_40px_rgba(255,0,0,0.1)] group transition-all duration-500 hover:scale-105">
                ...
                <img
                  ...
                  alt="Bhumisvara K - Software Developer"
